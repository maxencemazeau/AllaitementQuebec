        ...
        <div class="layout overflow-hidden">
            ...
            <nav class="navigation d-flex flex-column text-center navbar navbar-light hide-scrollbar">
                ...
                <a href="index.html" title="Messenger" class="d-none d-xl-block mb-6">
                    <svg version="1.1" width="46px" height="46px" fill="currentColor"  xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 46 46" enable-background="new 0 0 46 46" >
                ...
                <ul class="d-flex nav navbar-nav flex-row flex-xl-column flex-grow-1 justify-content-between justify-content-xl-center align-items-center w-100 py-4 py-lg-2 px-lg-3" role="tablist">
                    ...
                    <li class="nav-item d-none d-xl-block">
                        <a href="index.html" class="nav-link p-0 mt-lg-2" data-bs-toggle="modal" data-bs-target="#modal-profile">
                            ...
                            <div class="hide-scrollbar">
                                <div class="container py-8">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="mt-5">
                                            <a href="index.html" class="btn btn-lg btn-primary w-100 d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#modal-invite">
                                                Find Friends
                                    ...
                                    <div class="card-list">
                                        ...
                                        <div class="card border-0">
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-center gx-5">
                                                    <div class="col-auto">
                                                        <a href="index.html" class="avatar avatar-online">
                                ...
                                <div class="container py-8">
                                    ...
                                    <div class="card-list">
                                        ...
                                        <div class="d-flex align-items-center my-4 px-6">
                                            ...
                                            <a href="index.html" class="text-muted small">Clear all</a>
                                        </div>
                                        ...
                                        <div class="card border-0 mb-5">
                                            ...
                                            <div class="card-footer">
                                                <div class="row gx-4">
                                                    <div class="col">
                                                        <a href="index.html" class="btn btn-sm btn-soft-primary w-100">Hide</a>
                                                    </div>
                                                    <div class="col">
                                                        <a href="index.html" class="btn btn-sm btn-primary w-100">Confirm</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        ...
                                                        <a href="index.html" class="avatar avatar-badged" data-theme-toggle="tab">
                                ...
                                <div class="container py-8">
                                                ...
                                                <div class="accordion accordion-flush" id="accordion-profile">
                                                    <div class="accordion-item">
                                                        <div class="accordion-header" id="accordion-profile-1">
                                                            <a href="index.html" class="accordion-button text-reset collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-profile-body-1" aria-expanded="false" aria-controls="accordion-profile-body-1">
                                                                <div>
                                                    ...
                                                    <div class="accordion-item">
                                                        <div class="accordion-header" id="accordion-profile-2">
                                                            <a href="index.html" class="accordion-button text-reset collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-profile-body-2" aria-expanded="false" aria-controls="accordion-profile-body-2">
                                                                <div>
                                                ...
                                                <div class="accordion accordion-flush" id="accordion-security">
                                                    <div class="accordion-item">
                                                        <div class="accordion-header" id="accordion-security-1">
                                                            <a href="index.html" class="accordion-button text-reset collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-security-body-1" aria-expanded="false" aria-controls="accordion-security-body-1">
                                                                <div>
                                                                    <h5>Password</h5>
                                    ...
                                    <div class="mt-8">
                                        <div class="d-flex align-items-center my-4 px-6">
                                            ...
                                            <div class="flex align-items-center text-muted">
                                                <a href="index.html" class="text-muted small">Clear storage</a>
                                                ...
                                                <div class="accordion accordion-flush" id="accordion-storage">
                                                    <div class="accordion-item">
                                                        <div class="accordion-header" id="accordion-storage-1">
                                                            <a href="index.html" class="accordion-button text-reset collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-storage-body-1" aria-expanded="false" aria-controls="accordion-storage-body-1">
                                                                <div>
                                                                    <h5>Cache</h5>
                                                ...
                                                <div class="accordion accordion-flush" id="accordion-notifications">
                                                    <div class="accordion-item">
                                                        <div class="accordion-header" id="accordion-notifications-1">
                                                            <a href="index.html" class="accordion-button text-reset collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-notifications-body-1" aria-expanded="false" aria-controls="accordion-notifications-body-1">
                                                                <div>
                                                                    <h5>Message</h5>
                                    ...
                                    <div class="mt-8">
                                        <div class="d-flex align-items-center my-4 px-6">
                                            ...
                                            <div class="flex align-items-center text-muted">
                                                <a href="index.html" class="text-muted small">End all sessions</a>
            ...
            <div class="modal-dialog modal-dialog-centered modal-fullscreen-xl-down">
                <div class="modal-content">
                    ...
                    <div class="modal-body py-0">
                        ...
                        <div class="modal-py">
                            <a href="index.html" class="btn btn-lg btn-primary w-100 d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#invite-modal">
                                Send
            ...
            <div class="modal-dialog modal-dialog-centered modal-fullscreen-xl-down">
                <div class="modal-content">
                    ...
                    <div class="modal-body py-0">
                        ...
                        <div class="profile modal-gx-n">
                            ...
                            <div class="profile-body">
                                <div class="avatar avatar-xl">
                                    ...
                                    <a href="index.html" class="badge badge-lg badge-circle bg-primary text-white border-outline position-absolute bottom-0 end-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                                    </a>
                                </div>
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <a href="index.html" class="text-reset">Send Message</a>
                            </li>

                            <li class="list-group-item">
                                <a href="index.html" class="text-danger">Block User</a>
                            </li>
                        </ul>
